...
public class Cli {
	...
	/**
	 * Create a il.co.topq.integframework.cli.terminal.Cli object
	 * 
	...
	/**
	 * Get the il.co.topq.integframework.cli.terminal.Cli output text.
	 * 
	 * @return il.co.topq.integframework.cli.terminal.Cli capture text.
	 */
