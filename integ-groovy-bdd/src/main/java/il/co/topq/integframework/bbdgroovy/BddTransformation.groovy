...
public class BddTransformation implements ASTTransformation{
   ...
   public void visit(ASTNode[] nodes, SourceUnit sourceUnit) {
        ...
        methods.findAll { MethodNode method ->
            method.getAnnotations(new ClassNode(Bdd))
            ...
            List existingStatements = method.getCode().getStatementLabel()
